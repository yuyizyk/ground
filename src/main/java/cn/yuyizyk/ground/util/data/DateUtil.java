...
public class DateUtil {
	 ...
	 * etime 结束时间 @param @return 时间间隔 @return Duration Duration.toDays(); 取得时间间隔的天数
	 * Duration.toHours(); 取得时间将的小时数 Duration.toMinutes(); 取得时间间隔的分钟数 @throws
	 */
	...
	public static LocalDateTime parse(String str) {
		...
		String[] parsePatterns = { "yyyy-MM-dd", "yyyy/MM/dd", "dd/MM/yyyy", "HH:mm:ss", "yyyy-MM-dd HH:mm:ss",
				"yyyyMMdd HHmmss", "yyyyMMddHHmmss", "yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd'T'HH:mm:ss.SSS",
				"EEEE MMM dd HH:mm:ss Z yyyy", "MMM d, yyyy HH:mm:ss a", "yyyy年MM月dd日 HH时mm分ss秒" };
		Date date = new Date();
		try {
	 ...
	 * localDateTime @param @param pattern @param @return 设定文件 @return String
	 * 返回类型 @throws
	 */
	 ...
	 * LocalDateTime @param @param date @param @return 设定文件 @return LocalDateTime
	 * 返回类型 @throws
	 */
