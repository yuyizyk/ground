...
public class LoaderUtil {
	private static Logger log = LoggerFactory.getLogger(LoaderUtil.class);

	public static void main(String[] args) throws IOException {
		Set<Class<?>> set = getClzFromPkg("cn.yuyizyk.ground.service");
		set.forEach((c) -> {
	...
	public static Set<Class<?>> getClzFromPkg(String pkg) {
		...
		try {
			Enumeration<URL> urls = LoaderUtil.class.getClassLoader().getResources(pkgDirName);
